...
const Dashboard = () => {
  ...
  return (
    <div className="py-10 relative min-h-screen bg-gradient-to-b from-white to-gray-50">
      <BackgroundSVG />
            ...
            <Card className="border border-gray-100/60 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 overflow-hidden">
              ...
              <CardContent className="p-5">
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                  <Link to="/apply/new" className="no-underline">
                    <motion.div 
                  ...
                  <Link to="/apply/renew" className="no-underline">
                    <motion.div 
                ...
                <div className="flex flex-col md:flex-row gap-5 items-center">
                  ...
                  <div className="flex-1 text-center md:text-left">
                    ...
                    <div className="mt-4 flex flex-col sm:flex-row gap-3 justify-center md:justify-start">
                      ...
                      <Link to="/faqs" className="block w-full sm:w-auto">
